...
import {AppText, aboutSection} from '../Constants/index'
import { laptop, wave } from '../assets'

const About = () => {
  return (
    <div id="aboutme" className='mt-[100px]'>
          {/* <img src={wave}  className=" w-max absolute md-[200px]" /> */}
        <div className='w-full bg-purple-600 h-[500px] sm:h-[330px]  justify-center items-center'>
        ...
        <div className='flex flex-col md:flex-row mt-[-75px] md:px-32 '>
           {
            aboutSection.map((item,index)=>(
                ...
                group md:hover:bg-purple-600 mt-[30px] rounded-lg py-2">
