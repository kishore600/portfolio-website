import { aflacLogo, android, angular, cognizantLogo,
    facebook, firebase, instagram, linkdin, mysql,
     nodejs,
...
export const AppText={
   ...
   Contact:'Contact ',
   Us:'Us',
   copywriteText:'Copyright by Kishore k @2023',
    About:'About',
    Me:'Me',
}
...
export const aboutSection=[
   ...
   },
   {
       ...
       desc:'knowledge in React.js Tailwindcss Bootstrap5 Material UI'
   },
   {
       id:3,
...
export const workDetail=[
   { 
       id:1,
       year:'2021',
       position:'Blue Print App Technology',
       compnayName:'Backend Developer (03/01/2021- 31/05/2021) '
   },
   { 
       id:1,
       year:'2022',
       position:'Pantech e-learning',
       compnayName:'Full Stack Developer (20/12/2021-30/4/2022)  '
   },
   { 
       id:1,
       year:'2023',
       position:'Plant Green Inertia',
       compnayName:'Full Stack Developer (20/3/2023-30/4/2023) '
   },
]
